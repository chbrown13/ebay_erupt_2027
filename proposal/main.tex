...
Why academic research? Mining actionable patterns from a production codebase's \emph{history}, representing them in a queryable provenance-aware KG, and using that single substrate for both generation and convention-validation are open problems spanning software engineering, AI, and knowledge representation. They require systematic investigation, not engineering alone, and exceed what an in-house team has the bandwidth to explore.
