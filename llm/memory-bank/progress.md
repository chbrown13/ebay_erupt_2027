...
- [x] Full first draft of proposal — all 7 eRUPT sections (`proposal/main.tex`)
- [x] 12-month milestone/deliverable plan written
- [x] eBay-branded LaTeX styling in place
- [x] GitHub Actions workflows (Pages deploy + PR review)
...
| Window | Deliverable |
|--------|-------------|
| Months 1–7 | PoC Agentic KG scoped to ViewItem signals |
| Months 8–10 | Validation framework for agent-generated PRs |
| Months 11–12 | Empirical evaluation + publications (ICSE/FSE/MSR) |
